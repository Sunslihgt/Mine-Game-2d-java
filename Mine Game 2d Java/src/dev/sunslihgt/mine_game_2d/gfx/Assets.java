...
public class Assets {
	...
	public static final Rectangle defaultRectangle = new Rectangle(0, 0, width, height);
	...
	public static final Rectangle SMALL_CLOUD_RECT = new Rectangle(0, 0, width, height);
	public static final Rectangle SMALLEST_CLOUD_RECT = SMALL_CLOUD_RECT;
	public static final Rectangle MEDIUM_CLOUD_RECT = new Rectangle(0, 0, width * 2, height);
	public static final Rectangle BIG_CLOUD_RECT = new Rectangle(0, 0, width * 3, height);

	// Blocks
	public static Texture dirt_block, grass_block, stone_block, coal_ore_block, iron_ore_block, ruby_ore_block;
	public static Texture torch_block, chest_block, furnace_block_off, furnace_block_on;
	public static Texture selectedBlockOutline, oak_wood_block, oak_plank_block, oak_leaves_block;
	public static Texture[] block_breaking;
	
	// Background blocks
	public static Texture background_grass_block, background_dirt_block, background_stone_block;
	
	// Items
	public static Texture dirt_item, grass_item, stone_item, coal_ore_item, iron_ore_item, ruby_ore_item;
	public static Texture stick_item, torch_item, chest_item, furnace_item, coal_item, iron_ingot_item, ruby_item;
	public static Texture wooden_pickaxe_item, stone_pickaxe_item, iron_pickaxe_item;
	public static Texture wooden_axe_item, stone_axe_item, iron_axe_item;
	public static Texture wooden_shovel_item, stone_shovel_item, iron_shovel_item;
	public static Texture oak_wood_item, oak_plank_item, oak_leaves_item;
	
	// UI
	public static Texture empty_life_bar, full_life_bar;
	...
	public static void init() {
		try {
			...
			backgroundBlockTileSheet.unload();
			itemTileSheet.unload();
			uiTileSheet.unload();
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(1);
