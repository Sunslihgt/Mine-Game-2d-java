...
public class IronOreItem extends ItemType {

	public IronOreItem(int id) {
		super(id, "iron ore", Assets.iron_ore_item, 64, ToolType.NONE, 0, 1, 0f);
	}
	...
	public boolean rightClickAction(Handler handler) {
		...
		if (handler.getWorld().isEmptyBlock(playerCursorX, playerCursorY) && !handler.getPlayer().checkCollisionBlockPos(playerCursorX, playerCursorY)) {
			Block dirtBlock = new Block(playerCursorX, playerCursorY, BlockType.ironOreBlock);
